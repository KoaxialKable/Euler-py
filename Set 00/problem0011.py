...
def go(grid):
	highs = []
	highs.append(seekHorizontals(grid))
	highs.append(seekVerticals(grid))
	highs.append(seekFDiagonals(grid))
	highs.append(seekBDiagonals(grid))
	return sorted(highs)[-1]
